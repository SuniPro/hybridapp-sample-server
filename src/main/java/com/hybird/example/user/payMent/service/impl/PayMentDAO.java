...
public interface PayMentDAO {
	 ...
	 * @throws Exception
	 */
	public List<payHistoryVO> payHistoryList(@Param("userId") String userId, @Param("startDate") String startDate, @Param("endDate") String endDate, @Param("searchStatus") String searchStatus) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void clientCancelRequest(Map<String, Object> resultSucessMap) throws Exception;
	 ...
	 * @throws Exception
	 */
	public String bilkyInquiry(String userId) throws Exception;
